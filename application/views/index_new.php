                      ...
                      <table class="table table-striped table-bordered"> 
                        <tbody>
                          <tr>
                            ...
                            <td class="form-group">
                              <!-- <button class="btn btn-sm" type="file" ngf-select="onFileSelect($file, $invalidFiles)"
                                  accept="pdf/*" ngf-max-size="2MB" ng-class="memorandum ? 'btn-success' : 'btn-warning'">
                                  تحميل الملف
                              </button> -->
                              <!-- <div class="btn btn-sm" ngf-select ng-model="file" name="file" ngf-pattern="'pdf/*'"
                                ngf-accept="'pdf/*'" ngf-max-size="2MB">
                                تحميل الملف
                              </div> -->
                              <button class="btn btn-sm" type="file" ngf-select ng-model="memorandum" name="memorandum"
                               accept="pdf/*" ngf-max-size="2MB" required="required"
                               ngf-model-invalid="errorFiles" ng-class="memorandum ? 'btn-success' : 'btn-warning'">تحميل الملف</button>
                              <button type="button" class="btn btn-sm" ng-click="onFileSelect()">Upload</button>
                              <!-- <file-field type="file" class="btn btn-sm" ng-model="memorandum" ng-change="onFileSelect($file, $invalidFiles)" accept="pdf/*" ngf-max-size="2MB" ng-class="memorandum ? 'btn-success' : 'btn-warning'" preview="previewMemorandum">تحميل الملف</file-field> -->
                              ...
                              <br>
                              <br>
                                <i ng-show="myForm.memorandum.$error.required">*required</i>
                                <i ng-show="myForm.memorandum.$error.maxSize">
